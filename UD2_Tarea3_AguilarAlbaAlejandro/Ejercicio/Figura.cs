...
namespace UD2_Tarea3_AguilarAlbaAlejandro.Ejercicio {
    /// <summary> Clase Padre de todas las formas geometricas, siendo de caracter abstracto. </summary>
    /// <remarks>
    ...
    public abstract class Figura {
        /// <summary> Propiedad de la clase Figura, el la poscion horizontal. </summary>
        /// <remarks> Atributo float que la posicion horizontal en un espacio dimensional. </remarks>
        protected float posición_X;
        /// <summary> Propiedad de la clase Figura, el la poscion vertical. </summary>
        /// <remarks>Atributo float que la posicion vertical en un espacio dimensional. </remarks>
        ...
        /// debidoa a que los hijos los sobreescribira para sus intereses.
        /// </remarks>
        /// <returns> Devolvera su area. </returns>
